...
def download_rates():
    BASE_URL = "https://github.com/MaciejSkorski90/FX_data_pipeline_airflow/blob/main/data/api_forex_exchange.json"
    ENDPOINTS = {
...
with DAG("forex_data_pipeline", start_date=datetime(2021, 1 ,1), 
    ...
    is_forex_rates_available = HttpSensor(
        ...
        endpoint="mskorski/d45f272dea4dfd3eab015a4a1af4b39c",
